...
class TestUpdateCompliance(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.directory.write(
            "Device Configurations/test.json", '{"test": "test"}',
            encoding='utf-8')
        self.directory.write(
            ...
            encoding='utf - 8')
        self.token = 'token'
        self.mem_data_base = {"value": [{"@odata.type": "test",
                                         "id": "0",
                                         "displayName": "test",
                                         "testvalue": "test",
                                         "assignments": [{"target": {"groupId": "test"}}]}]}
        self.repo_data_base = {"@odata.type": "test",
                               "id": "0",
                               "displayName": "test",
                               "testvalue": "test1",
        ...
        self.makeapirequest_patch = patch(
            'src.IntuneCD.update_profiles.makeapirequest')
        ...
        self.load_file_patch = patch(
            'src.IntuneCD.update_profiles.load_file')
        ...
        self.plistlib.load.return_value = {
            'PayloadContent': [{'test': 'test'}]}
