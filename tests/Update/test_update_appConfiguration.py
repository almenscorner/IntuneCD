...
class TestUpdateAppConfiguration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.makeapirequestDelete_patch = patch("src.IntuneCD.update_appConfiguration.makeapirequestDelete")
    ...
    def test_update_with_diffs_and_assignment(self):
        ...
        self.count = update(self.directory.path, self.token, assignment=True, remove=False)
    ...
    def test_update_with_diffs_no_assignment(self):
        ...
        self.count = update(self.directory.path, self.token, assignment=False, remove=False)
