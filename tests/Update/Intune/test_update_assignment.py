...
from src.IntuneCD.update.Intune.update_assignment import (
    get_added_removed,
    update_assignment,
)
...
class TestUpdateAssignment(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.makeapirequest_patch = patch(
            "src.IntuneCD.update.Intune.update_assignment.makeapirequest"
        )
        self.makeapirequest = self.makeapirequest_patch.start()

        self.makeapirequestPost_patch = patch(
            "src.IntuneCD.update.Intune.update_assignment.makeapirequestPost"
        )
