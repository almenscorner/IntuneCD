...
from src.IntuneCD.update.Intune.update_deviceManagementSettings import update
...
class TestUpdateDeviceManagementSettings(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.makeapirequest_patch = patch(
            "src.IntuneCD.update.Intune.update_deviceManagementSettings.makeapirequest"
        )
        self.makeapirequest = self.makeapirequest_patch.start()
        self.makeapirequest.return_value = self.mem_data

        self.load_file_patch = patch(
            "src.IntuneCD.update.Intune.update_deviceManagementSettings.load_file"
        )
        self.load_file = self.load_file_patch.start()
        self.load_file.return_value = self.repo_data

        self.makeapirequestPatch_patch = patch(
            "src.IntuneCD.update.Intune.update_deviceManagementSettings.makeapirequestPatch"
        )
        self.makeapirequestPatch = self.makeapirequestPatch_patch.start()

        self.makeapirequestPost_patch = patch(
            "src.IntuneCD.update.Intune.update_deviceManagementSettings.makeapirequestPost"
        )
