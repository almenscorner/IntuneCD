...
class TestUpdateAppleEnrollmentProfile(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.makeapirequest_patch = patch(
            "src.IntuneCD.update.Intune.update_appleEnrollmentProfile.makeapirequest"
        )
        self.makeapirequest = self.makeapirequest_patch.start()
        self.makeapirequest.return_value = self.mem_data

        self.load_file_patch = patch(
            "src.IntuneCD.update.Intune.update_appleEnrollmentProfile.load_file"
        )
        self.load_file = self.load_file_patch.start()
        self.load_file.return_value = self.repo_data

        self.makeapirequestPatch_patch = patch(
            "src.IntuneCD.update.Intune.update_appleEnrollmentProfile.makeapirequestPatch"
        )
