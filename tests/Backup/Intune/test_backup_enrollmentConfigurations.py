...
from src.IntuneCD.backup.Intune.backup_enrollmentConfigurations import savebackup
...
class TestBackupEnrollmentConfigurations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.object_assignment_patch = patch(
            "src.IntuneCD.backup.Intune.backup_enrollmentConfigurations.get_object_assignment"
        )
        self.object_assignment = self.object_assignment_patch.start()
        self.object_assignment.return_value = OBJECT_ASSIGNMENT

        self.makeapirequest_patch = patch(
            "src.IntuneCD.backup.Intune.backup_enrollmentConfigurations.makeapirequest"
        )
