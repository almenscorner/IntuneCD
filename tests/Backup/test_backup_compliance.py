...
class TestBackupCompliance(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.expected_data = {
            ...
            "displayName": "test",
            "scheduledActionsForRule": [{"ruleName": None, "scheduledActionConfigurations": [{"gracePeriodHours": 0}]}],
            ...
            "value": [
                {
                    ...
                    "scheduledActionsForRule": [
                        {"ruleName": None, "scheduledActionConfigurations": [{"id": "0", "gracePeriodHours": 0}]}
                    ],
                }
            ]
        }
