...
REMOTE_ASSISTANCE_PARTNER = {"value": [{"id": "0", "onboardingStatus": "onboarded", "displayName": "test"}]}


@patch("src.IntuneCD.backup_remoteAssistancePartner.savebackup")
@patch("src.IntuneCD.backup_remoteAssistancePartner.makeapirequest", return_value=REMOTE_ASSISTANCE_PARTNER)
