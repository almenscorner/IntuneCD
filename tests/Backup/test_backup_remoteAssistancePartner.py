...
@patch("src.IntuneCD.backup_remoteAssistancePartner.makeapirequest",
...
class TestBackupCompliancePartner(unittest.TestCase):
    ...
    def test_backup_yml(self, mock_data, mock_makeapirequest):
        ...
        self.assertTrue(
            Path(f'{self.directory.path}/Partner Connections/Remote Assistance').exists())
    ...
    def test_onboarding_status_not_onboarded(
            self, mock_data, mock_makeapirequest):
