...
class TestBackupApplications(unittest.TestCase):
    ...
    def test_backup_ios_vpp_app(self):
        ...
        self.assertTrue(
            Path(
                self.directory.path +
                '/Applications/iOS').exists())
        self.assertTrue(
            Path(
                self.directory.path +
                '/Applications/iOS/test_iOSVppApp_test.json').exists())
    ...
    def test_backup_other_app(self):
        ...
        self.assertTrue(
            Path(
                self.directory.path +
                '/Applications/macOS/test_macOSother.json').exists())
        self.assertEqual(1, self.count)
