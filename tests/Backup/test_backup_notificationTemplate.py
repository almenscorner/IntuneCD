...
def side_effects_makeapirequest():
    ...
    MESSAGE_TEMPLATE = {
        'value': [{'id': '0',
                   ...
                   'roleScopeTagIds': ['0'],
                   'localizedNotificationMessages': [{'id': '0',
...
@patch("src.IntuneCD.backup_notificationTemplate.makeapirequest",
...
class TestBackupNotificationTemplate(unittest.TestCase):
    ...
    def test_backup_yml(self, mock_data, mock_makeapirequest):
        ...
        self.assertTrue(
            Path(f'{self.directory.path}/Compliance Policies/Message Templates').exists())
