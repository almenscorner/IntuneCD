...
class TestBackupProfiles(unittest.TestCase):
    ...
    def test_backup_macOS_custom_profile(self):
        ...
        self.assertTrue(Path(
            f"{self.directory.path}/Device Configurations/test_macOSCustomConfiguration.json").exists())
        self.assertTrue(Path(
    ...
    def test_backup_ios_custom_profile(self):
        ...
        self.assertTrue(Path(
            f"{self.directory.path}/Device Configurations/test_iosCustomConfiguration.json").exists())
        self.assertTrue(Path(
            f"{self.directory.path}/Device Configurations/mobileconfig/test.mobileconfig").exists())
        self.assertEqual(2, self.count)
