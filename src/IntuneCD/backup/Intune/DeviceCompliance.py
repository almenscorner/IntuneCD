...
def _check_linux_discovery_script(data: dict) -> bool:
...
def _get_detection_script_id(data: dict, path=None) -> list:
...
class DeviceComplianceBackupModule(BaseBackupModule):
    ...
    def main(self) -> dict[str, any]:
        ...
        for item in self.graph_data["value"]:
            ...
            if _check_linux_discovery_script(item):
                # Get the detection script ID
                detection_script_id_path = _get_detection_script_id(item)
