...
ENDPOINT = "https://graph.microsoft.com/beta/policies/externalidentitiespolicy"
...
def savebackup(path, output, token):
    ...
    if data:
        ...
        print(
            "Backing up Entra External Collaboration Settings External Identity Policy"
        )

        # Get filename without illegal characters
        fname = "external_identities_policy"
