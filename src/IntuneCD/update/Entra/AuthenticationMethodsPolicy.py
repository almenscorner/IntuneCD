...
class AuthenticationMethodsPolicyUpdateModule(BaseUpdateModule):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.config_type = "Authentication Methods Policy"
        self.handle_assignment = False
        self.exclude_paths = [
            "root['authenticationMethodConfigurations']",
            "root['policyMigrationState']",
        ]
