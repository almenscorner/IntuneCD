...
BASE_ENDPOINT = "https://graph.microsoft.com/beta/policies/externalidentitiespolicy"
...
def update(path, token, report):
    ...
    # If external identities policy path exists, continue
    if file:
        ...
        if entra_data:
            ...
            diff_config = DiffSummary(
                data=diff,
                name="External Identities Policy",
