...
class DomainsUpdateModule(BaseUpdateModule):
    """A class used to update Entra Domains
    ...
    def __init__(self, *args, **kwargs):
        """Initializes the DomainsUpdateModule class
