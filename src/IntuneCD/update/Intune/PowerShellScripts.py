...
class PowerShellScriptsUpdateModule(BaseUpdateModule):
    """A class used to update Intune PowerShell Scripts
    ...
    def main(self) -> dict[str, any]:
        ...
        if self.path_exists():
            ...
            powershell_script_data = self.graph.batch_request(
                profile_ids,
            ...
            for filename in filenames:
                ...
                if repo_data:
                    ...
                    try:
                        self.process_update(
                            downstream_data=powershell_script_data,
                            repo_data=repo_data,
                            method="patch",
                            status_code=200,
            ...
            self.remove_downstream_data(self.CONFIG_ENDPOINT, powershell_script_data)
