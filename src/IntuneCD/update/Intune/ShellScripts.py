...
class ShellScriptsUpdateModule(BaseUpdateModule):
    """A class used to update Intune Shell Scripts
    ...
    def __init__(self, *args, **kwargs):
        """Initializes the ShellScriptsUpdateModule class
    ...
    def main(self) -> dict[str, any]:
        ...
        if self.path_exists():
            ...
            shell_script_data = self.graph.batch_request(
                profile_ids,
