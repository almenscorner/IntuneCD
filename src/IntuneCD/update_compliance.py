            ...
            with open(file) as f:
                    if filename.endswith(".yaml"):
                        ...
                        q_param = {"$filter": "displayName eq " + "'" +
                            repo_data['displayName'] + "'", "expand": "scheduledActionsForRule($expand=scheduledActionConfigurations)"}
                    ...
                    if mem_data['value']:
                        ...
                        if repo_data['scheduledActionsForRule']:
                            ...
                            if rdiff:
                                ...
                                print(
                                    'No difference in rules found for Compliance policy: ' + repo_data['displayName'])
                        else:
                            print(
                                'No difference found for Compliance policy: ' + repo_data['displayName'])
